from models import LanguageModel, VisionLanguageModel
...
def get_model(model_name: str, device: str, logger, **kwargs):
    """
    Return an instance of LanguageModel or VisionLanguageModel
    based on the model name.

    Args:
        model_name: Hugging Face model name.
        device: Device to use for inference, such as a GPU or CPU.
        logger: Logger instance.
        **kwargs: Generation parameters such as top_p, top_k,
            temperature, and max_new_tokens.

    Returns:
        An instance of LanguageModel or VisionLanguageModel.
